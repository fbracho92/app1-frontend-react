...
const ProductCard = React.memo(({ prod, addToCart, isAuditMode, isZombieShift }) => {
    ...
    const handleCardClick = async () => {
        ...
        if (isFractionable) {
            ...
            if (measureData) {
                // 🚨 BLINDAJE 1000%: Contrabandeamos el peso real (measureData.amount) dentro del ID
                // El backend cortará este string y sacará el número para el Kardex
                const fractionedProduct = {
                    ...prod,
                    id: prod.id + '-UOM-' + measureData.amount + '-' + Date.now(),
